...
def readFile():
    ...
    try: 
        ...
        print("Line number",lineNumber,"in the words.txt file does not have a valid category")
        return ""
    except FileDifficultyError:
        print("Line number",lineNumber,"in the words.txt file does not have a valid difficulty")
        return ""
    except FileEmptyLineError:
        print("Line number",lineNumber,"in the words.txt file is empty or only has white spaces.")
        return ""
    except:
        print("words.txt file was not found.")
        return ""
...
class FileCategoryError(Exception):
    """
    Purpose: A custom exception used to indicate that a line in the file has an invalid category.
    """
    pass

class FileDifficultyError(Exception):
    """
    Purpose: A custom exception used to indicate that a line in the file has an invalid difficulty.
    """
    pass
        
class FileEmptyLineError(Exception):
    """
    Purpose: A custom exception used to indicate that a line in the file is empty or only has white spaces.
    """
    pass
